...
export function Modal({
  ...
  const panelClass = isSheet
    ? `w-full ${sizeClasses[size]} max-h-[92vh] flex flex-col !p-0 bg-[var(--color-surface)] rounded-t-[var(--radius-xl)] shadow-xl cz-sheet-enter cz-pb-safe`
    : `w-full ${sizeClasses[size]} max-h-[92vh] md:max-h-[90vh] flex flex-col !p-0 bg-[var(--color-surface)] rounded-t-[var(--radius-xl)] md:rounded-[var(--radius-lg)] shadow-xl cz-sheet-enter md:!animate-none cz-pb-safe`;
