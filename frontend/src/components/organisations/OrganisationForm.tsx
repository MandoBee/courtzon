...
const branchBlank = { name: '', slug: '', description: '', email: '', phone: '', addressLine1: '', city: '', state: '', postalCode: '', accessType: 'open', coachPolicy: 'contract_required', timezone: 'Africa/Cairo', countryId: undefined as number | undefined, openingTime: '00:00', closingTime: '23:59', latitude: undefined as number | undefined, longitude: undefined as number | undefined };
