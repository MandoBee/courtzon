...
export const uiRegistry: UIElement[] = [
  ...
  { permissionKey: 'org.tournaments.delete', moduleSlug: 'org', elementType: 'button', elementLabel: 'Org Archive Tournament', componentPath: 'pages/org/OrgTournamentDetailPage.tsx' },
  { permissionKey: 'org.tournaments.manage', moduleSlug: 'org', elementType: 'action', elementLabel: 'Org Manage Groups/Fixtures/Bracket', componentPath: 'pages/org/OrgTournamentDetailPage.tsx' },
  { permissionKey: 'org.tournaments.register', moduleSlug: 'org', elementType: 'action', elementLabel: 'Org Manage Registrations', componentPath: 'pages/org/OrgTournamentDetailPage.tsx' },
  { permissionKey: 'org.tournaments.result.manage', moduleSlug: 'org', elementType: 'action', elementLabel: 'Org Manage Match Results', componentPath: 'pages/org/OrgTournamentDetailPage.tsx' },
  ...
  { permissionKey: 'branches.edit.coach-policy', moduleSlug: 'branches', elementType: 'field', elementLabel: 'Branch Coach Policy Field', componentPath: 'components/organisations/OrganisationForm.tsx' },
  ...
  { permissionKey: 'matches.admin.view', moduleSlug: 'bookings', elementType: 'page', elementLabel: 'Matches Monitoring (Admin)', componentPath: 'pages/admin/Matches/AdminMatchesPage.tsx' },
  ...
  { permissionKey: 'matches.result.submit', moduleSlug: 'bookings', elementType: 'button', elementLabel: 'Submit Match Result', componentPath: 'pages/booking/MatchResultPage.tsx' },
  { permissionKey: 'matches.result.accept', moduleSlug: 'bookings', elementType: 'button', elementLabel: 'Accept Match Result', componentPath: 'pages/booking/MatchResultPage.tsx' },
  { permissionKey: 'matches.result.dispute', moduleSlug: 'bookings', elementType: 'button', elementLabel: 'Dispute Match Result', componentPath: 'pages/booking/MatchResultPage.tsx' },
  { permissionKey: 'matches.result.manage', moduleSlug: 'bookings', elementType: 'page', elementLabel: 'Manage Match Results (resolve/correct)', componentPath: 'pages/admin/match-results/AdminMatchResultsPage.tsx' },
  { permissionKey: 'matches.result.rules', moduleSlug: 'bookings', elementType: 'action', elementLabel: 'View Sport Formats & Rules', componentPath: 'pages/booking/MatchResultPage.tsx' },
  { permissionKey: 'matches.result.rules.manage', moduleSlug: 'bookings', elementType: 'action', elementLabel: 'Manage Sport Rule Sets', componentPath: 'pages/admin/match-results/AdminMatchResultsPage.tsx' },
  { permissionKey: 'org.matches.view', moduleSlug: 'bookings', elementType: 'page', elementLabel: 'Organisation Matches Monitoring', componentPath: 'pages/org/Matches/OrgMatchesPage.tsx' },
  { permissionKey: 'org.matches.results.view', moduleSlug: 'bookings', elementType: 'page', elementLabel: 'Organisation Match Results Moderation', componentPath: 'pages/org/Matches/OrgMatchResultsPage.tsx' },
  { permissionKey: 'org.sidebar.matches', moduleSlug: 'organisations', elementType: 'action', elementLabel: 'Organisation Sidebar Matches Link', componentPath: 'navigation/org.registry.ts' },
  { permissionKey: 'org.sidebar.match-results', moduleSlug: 'organisations', elementType: 'action', elementLabel: 'Organisation Sidebar Match Results Link', componentPath: 'navigation/org.registry.ts' },
  ...
  { permissionKey: 'coaches.book', moduleSlug: 'coaches', elementType: 'button', elementLabel: 'Book a Coach', componentPath: 'pages/coaches/CoachDetailPage.tsx' },
  ...
  { permissionKey: 'coaches.service_locations.manage', moduleSlug: 'coaches', elementType: 'section', elementLabel: 'Manage Coach Service Locations (Branches)', componentPath: 'pages/coaches/CoachProfilePage.tsx' },
  ...
  { permissionKey: 'sidebar.withdrawals-queue', moduleSlug: 'financial', elementType: 'tab', elementLabel: 'Sidebar: Withdrawals Queue', componentPath: 'components/layout/AdminSidebar.tsx' },
  { permissionKey: 'financial.withdrawals.view', moduleSlug: 'financial', elementType: 'page', elementLabel: 'View Withdrawal Requests (Player)', componentPath: 'pages/player/WithdrawalPage.tsx' },
  { permissionKey: 'financial.withdrawals-queue.view', moduleSlug: 'financial', elementType: 'page', elementLabel: 'View Withdrawals Queue (Admin)', componentPath: 'pages/admin/WithdrawalQueuePage.tsx' },
  { permissionKey: 'sidebar.finance-transactions', moduleSlug: 'financial', elementType: 'tab', elementLabel: 'Sidebar: Finance (Transactions & Settlements)', componentPath: 'pages/admin/finance/FinancialOpsDashboard.tsx' },
  ...
  { permissionKey: 'financial.entitlements.view', moduleSlug: 'financial', elementType: 'page', elementLabel: 'View Financial Entitlements' },
  { permissionKey: 'financial.entitlements.hold', moduleSlug: 'financial', elementType: 'button', elementLabel: 'Hold/Release Entitlement' },
  { permissionKey: 'financial.entitlements.cancel', moduleSlug: 'financial', elementType: 'button', elementLabel: 'Cancel Entitlement' },
  { permissionKey: 'marketplace.complaints.submit', moduleSlug: 'marketplace', elementType: 'action', elementLabel: 'Submit Marketplace Complaint' },
  { permissionKey: 'marketplace.complaints.view', moduleSlug: 'marketplace', elementType: 'page', elementLabel: 'View Marketplace Complaints' },
  { permissionKey: 'marketplace.complaints.manage', moduleSlug: 'marketplace', elementType: 'action', elementLabel: 'Manage Marketplace Complaints' },
  { permissionKey: 'marketplace.complaints.approve', moduleSlug: 'marketplace', elementType: 'action', elementLabel: 'Approve Marketplace Refunds' },
  ...
  { permissionKey: 'academy.waitlist.replace', moduleSlug: 'academy', elementType: 'action', elementLabel: 'Out-of-order Waitlist Replacement (requires reason)', componentPath: 'pages/admin/academy/AcademyEnrollmentsPage.tsx' },
  ...
  { permissionKey: 'academy.schedule.view', moduleSlug: 'academy', elementType: 'page', elementLabel: 'Academy Recurring Schedules Page', componentPath: 'pages/admin/academy/AcademySchedulesPage.tsx' },
  { permissionKey: 'academy.schedule.manage', moduleSlug: 'academy', elementType: 'action', elementLabel: 'Manage Academy Recurring Schedules (create/update/status)', componentPath: 'pages/admin/academy/AcademySchedulesPage.tsx' },
  { permissionKey: 'academy.schedule.resolve', moduleSlug: 'academy', elementType: 'action', elementLabel: 'Resolve Academy Session Conflicts', componentPath: 'pages/admin/academy/AcademySchedulesPage.tsx' },
  { permissionKey: 'academy.session.view', moduleSlug: 'academy', elementType: 'page', elementLabel: 'View Academy Sessions (list/roster/summary)', componentPath: 'pages/admin/academy/AcademySessionsPage.tsx' },
  { permissionKey: 'academy.session.manage', moduleSlug: 'academy', elementType: 'action', elementLabel: 'Start/Complete/Cancel Academy Sessions', componentPath: 'pages/admin/academy/AcademySessionsPage.tsx' },
  { permissionKey: 'academy.coach.session.view', moduleSlug: 'academy', elementType: 'page', elementLabel: 'Coach: View Own Academy Sessions (list/detail/roster)', componentPath: 'pages/coaches/CoachAcademySessionsPage.tsx' },
  { permissionKey: 'academy.coach.session.manage', moduleSlug: 'academy', elementType: 'action', elementLabel: 'Coach: Start/Complete/Cancel Own Academy Sessions', componentPath: 'pages/coaches/CoachAcademySessionsPage.tsx' },
  { permissionKey: 'academy.coach.attendance.manage', moduleSlug: 'academy', elementType: 'action', elementLabel: 'Coach: Mark/Update Attendance for Own Academy Sessions', componentPath: 'pages/coaches/CoachAcademySessionsPage.tsx' },
  { permissionKey: 'sidebar.academy-sessions', moduleSlug: 'academy', elementType: 'tab', elementLabel: 'Sidebar: Academy Sessions', componentPath: 'components/layout/AdminSidebar.tsx' },
  ...
  { permissionKey: 'sidebar.academy-schedules', moduleSlug: 'academy', elementType: 'tab', elementLabel: 'Sidebar: Academy Recurring Schedules', componentPath: 'components/layout/AdminSidebar.tsx' },
  ...
  { permissionKey: 'org.resources.manage', moduleSlug: 'org', elementType: 'page', elementLabel: 'Manage Organisation Resources', componentPath: 'pages/org/OrgBranchesPage.tsx' },
  ...
  { permissionKey: 'org.accounting.view', moduleSlug: 'org', elementType: 'page', elementLabel: 'Organisation Accounting Periods (view)', componentPath: 'pages/org/OrgAccountingPeriodsPage.tsx' },
  { permissionKey: 'org.accounting.manage', moduleSlug: 'org', elementType: 'button', elementLabel: 'Organisation Accounting Periods Manage (generate/close/open/close-year)', componentPath: 'pages/org/OrgAccountingPeriodsPage.tsx' },
  { permissionKey: 'org.accounting.journal.create', moduleSlug: 'org', elementType: 'button', elementLabel: 'Organisation Manual Journal Create', componentPath: 'pages/org/OrgAccountingRecordsPage.tsx' },
  ...
  { permissionKey: 'accounting.templates.view', moduleSlug: 'accounting', elementType: 'page', elementLabel: 'Account Templates View', componentPath: 'pages/admin/accounting/TemplatesPage.tsx' },
  { permissionKey: 'accounting.templates.manage', moduleSlug: 'accounting', elementType: 'button', elementLabel: 'Manage Account Templates', componentPath: 'pages/admin/accounting/TemplatesPage.tsx' },
  ...
  { permissionKey: 'accounting.reconciliation.view', moduleSlug: 'accounting', elementType: 'page', elementLabel: 'Reconciliation View', componentPath: 'pages/admin/accounting/ReconciliationPage.tsx' },
  ...
  { permissionKey: 'sidebar.accounting-templates', moduleSlug: 'accounting', elementType: 'tab', elementLabel: 'Sidebar: Account Templates', componentPath: 'components/layout/AdminSidebar.tsx' },
  ...
  { permissionKey: 'hr.contracts.view', moduleSlug: 'hr', elementType: 'page', elementLabel: 'HR Contracts Page' },
  { permissionKey: 'hr.contracts.manage', moduleSlug: 'hr', elementType: 'action', elementLabel: 'Manage HR Contracts' },
  { permissionKey: 'hr.positions.view', moduleSlug: 'hr', elementType: 'page', elementLabel: 'HR Positions Page' },
  { permissionKey: 'hr.positions.manage', moduleSlug: 'hr', elementType: 'action', elementLabel: 'Manage HR Positions' },
  { permissionKey: 'hr.leaves.types.view', moduleSlug: 'hr', elementType: 'page', elementLabel: 'Leave Types Page', componentPath: 'pages/admin/hr/LeaveManagementPage.tsx' },
  { permissionKey: 'hr.leaves.types.manage', moduleSlug: 'hr', elementType: 'action', elementLabel: 'Manage Leave Types', componentPath: 'pages/admin/hr/LeaveManagementPage.tsx' },
  { permissionKey: 'hr.leaves.requests.view', moduleSlug: 'hr', elementType: 'page', elementLabel: 'Leave Requests Page', componentPath: 'pages/admin/hr/LeaveManagementPage.tsx' },
  { permissionKey: 'hr.leaves.requests.manage', moduleSlug: 'hr', elementType: 'action', elementLabel: 'Manage Leave Requests', componentPath: 'pages/admin/hr/LeaveManagementPage.tsx' },
  { permissionKey: 'hr.leaves.requests.approve', moduleSlug: 'hr', elementType: 'action', elementLabel: 'Approve Leave Requests', componentPath: 'pages/admin/hr/LeaveManagementPage.tsx' },
  { permissionKey: 'hr.leaves.balances.view', moduleSlug: 'hr', elementType: 'page', elementLabel: 'Leave Balances Page', componentPath: 'pages/admin/hr/LeaveManagementPage.tsx' },
  { permissionKey: 'hr.leaves.balances.manage', moduleSlug: 'hr', elementType: 'action', elementLabel: 'Manage Leave Balances', componentPath: 'pages/admin/hr/LeaveManagementPage.tsx' },
  { permissionKey: 'hr.payroll.components.view', moduleSlug: 'hr', elementType: 'page', elementLabel: 'Payroll Components Page', componentPath: 'pages/admin/hr/PayrollPage.tsx' },
  { permissionKey: 'hr.payroll.components.manage', moduleSlug: 'hr', elementType: 'action', elementLabel: 'Manage Payroll Components', componentPath: 'pages/admin/hr/PayrollPage.tsx' },
  { permissionKey: 'hr.payroll.runs.view', moduleSlug: 'hr', elementType: 'page', elementLabel: 'Payroll Runs Page', componentPath: 'pages/admin/hr/PayrollPage.tsx' },
  { permissionKey: 'hr.payroll.runs.manage', moduleSlug: 'hr', elementType: 'action', elementLabel: 'Manage Payroll Runs', componentPath: 'pages/admin/hr/PayrollPage.tsx' },
  { permissionKey: 'hr.payroll.runs.calculate', moduleSlug: 'hr', elementType: 'action', elementLabel: 'Calculate Payroll Run', componentPath: 'pages/admin/hr/PayrollPage.tsx' },
  { permissionKey: 'hr.payroll.runs.approve', moduleSlug: 'hr', elementType: 'action', elementLabel: 'Approve Payroll Run', componentPath: 'pages/admin/hr/PayrollPage.tsx' },
  { permissionKey: 'hr.payroll.runs.post', moduleSlug: 'hr', elementType: 'action', elementLabel: 'Post Payroll Run', componentPath: 'pages/admin/hr/PayrollPage.tsx' },
