...
function canManageTournaments(templateSlug, permissionKey) {
...
function isSellerDeniedTournamentKey(permissionKey) {
...
const MARKETPLACE_MANAGER_PATTERNS = [
  ...
  // operations-manager; see role-permission-templates.ts).
