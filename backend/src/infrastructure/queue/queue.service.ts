...
export type JobType = 'send_email' | 'process_settlement' | 'cancel_expired_bookings' | 'database_backup' | 'run_settlements' | 'auto_complete_bookings' | 'sync_pending_payments' | 'expire_stale_payments' | 'cleanup_booking_intents';
