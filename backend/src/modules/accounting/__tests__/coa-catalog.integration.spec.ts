...
describe('L4 Catalog + Organisation COA Customization', () => {
  ...
  it('catalog contains the expected default L4 accounts with correct parents', async () => {
    const cases: [string, string, string, string][] = [
      ...
      ['4110', 'Court Booking Commission Revenue', 'REVENUE-COURT', 'revenue'],
      ['4160', 'Marketplace Commission Revenue', 'REVENUE-COURT', 'revenue'],
      ['4180', 'League Commission Revenue', 'REVENUE-COURT', 'revenue'],
      ['4191', 'Academy Commission Revenue', 'REVENUE-COURT', 'revenue'],
      ['4192', 'Tournament Commission Revenue', 'REVENUE-COURT', 'revenue'],
      ['4193', 'Coach Session Commission Revenue', 'REVENUE-COURT', 'revenue'],
