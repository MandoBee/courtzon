...
export async function registerOrgPortalRoutes(app: FastifyInstance): Promise<void> {
  ...
  app.put('/org/:orgId/coaches/:coachId/suspend', { preHandler: [orgManageGuard] }, ctrl.suspendOrgCoachHandler);
  app.put('/org/:orgId/coaches/:coachId/resume', { preHandler: [orgManageGuard] }, ctrl.resumeOrgCoachHandler);
  app.put('/org/:orgId/coaches/:coachId/end', { preHandler: [orgManageGuard] }, ctrl.endOrgCoachHandler);
  ...
  app.get('/org/:orgId/settlements/outstanding', { preHandler: [orgAccessGuard] }, ctrl.getOrgSettlementsOutstandingHandler);
  app.post('/org/:orgId/settlements', { preHandler: [orgAccessGuard, requireOrgScopedPermission('settlements.request')] }, ctrl.createOrgSettlementHandler);
