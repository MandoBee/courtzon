...
export interface DomainEventMap {
  ...
  'coach:platform-activated': BaseEvent & { userId: number; coachId: number };
  ...
  'coach:org-resumed': BaseEvent & { coachId: number; coachUserId: number; organisationId: number; organisationName: string };
  'coach:org-ended': BaseEvent & { coachId: number; coachUserId: number; organisationId: number; organisationName: string };
  'coach:invite-accepted': BaseEvent & { coachId: number; coachUserId: number; organisationId: number; organisationName: string };
  ...
  'settlement:paid': BaseEvent & { settlementId: number; organisationId: number; amount: number; direction?: string; currency?: string; onlineNet?: number; codFee?: number };
