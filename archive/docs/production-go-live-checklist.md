...
| [ ] N / [ ] P / [ ] C | **5.6** | Build pack: Dockerfile (not Nixpacks) | Resource -> Application: Git repo, Dockerfile: `backend/Dockerfile`, **Build context: `.` (root)**, Port: `3000` | Build uses root context, not `backend/` |
