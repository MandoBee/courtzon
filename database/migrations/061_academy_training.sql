-- ============================================================================
-- Sprint 6 — Academy & Training Foundation
-- ============================================================================
-- This migration is additive. It does not modify any existing tables.
-- Legacy academy_enrollments is renamed for clarity.
-- ============================================================================

-- Rename legacy table to preserve data without blocking new naming
RENAME TABLE academy_enrollments TO academy_enrollments_legacy;

-- ── academy_programs ──────────────────────────────────────────────────────
-- Core entity: a template/plan for a training program
...
-- ── academy_groups ────────────────────────────────────────────────────────
-- Operational unit within a program. Players enroll into groups.
...
-- ── academy_enrollments ───────────────────────────────────────────────────
-- Production enrollment table (replaces legacy naming).
CREATE TABLE academy_enrollments (
  ...
  CONSTRAINT fk_enroll_program  FOREIGN KEY (program_id) REFERENCES academy_programs(id)    ON DELETE CASCADE,
  CONSTRAINT fk_enroll_group    FOREIGN KEY (group_id)   REFERENCES academy_groups(id)       ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- ── academy_group_sessions ────────────────────────────────────────────────
-- Actual scheduled sessions within a group. Attendance is recorded against these.
...
-- ── academy_attendance ────────────────────────────────────────────────────
-- Immutable attendance records linked to group sessions.
